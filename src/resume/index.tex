...
\subsubsection*{Medical Assistant - Planned Parenthood of Michigan}
\label{sec:org3f9e6ea}
\subparagraph*{\emph{November 2025 - Present}}
\label{sec:org0bd6c78}
\begin{itemize}
\item Maintained accurate patient records and efficiently entered data
into electronic health record (EHR) systems while supporting
patient access and demand goals
\item Greeted patients, managed check-in processes, verified insurance
coverage, and obtained health plan authorizations to ensure
seamless front-office operations
\item Assessed patient financial eligibility for assistance programs,
collected fees, and recorded billing transactions in accordance
with cash handling policies
\item Performed clinical support duties including obtaining vital signs,
conducting urinalyses, rapid HIV tests, finger sticks,
venipuncture, and administering injections
\item Prepared patients for exams and procedures, assisted clinicians
during care, and provided education on pain management options
\item Delivered unbiased, factual patient education on pregnancy options,
birth control methods, sexually transmitted infections, and other
health services, screening for coercion and referring to external
resources as needed
\item Dispensed medications and supplies under clinician direction, and
managed lab specimen preparation, requisitions, and transport logs
\end{itemize}
\subsubsection*{Gas Station Attendant - Meijer}
\label{sec:orgfe902f6}
\subparagraph*{\emph{June 2025 - November 2025}}
\label{sec:orgb0faf72}
\begin{itemize}
...
\subparagraph*{\emph{January 2015 - December 2017}}
\label{sec:org134d018}
\begin{itemize}
