...
** _Experience_
*** Medical Assistant - Planned Parenthood of Michigan
***** /November 2025 - Present/
 * Maintained accurate patient records and efficiently entered data
   into electronic health record (EHR) systems while supporting
   patient access and demand goals
 * Greeted patients, managed check-in processes, verified insurance
   coverage, and obtained health plan authorizations to ensure
   seamless front-office operations
 * Assessed patient financial eligibility for assistance programs,
   collected fees, and recorded billing transactions in accordance
   with cash handling policies
 * Performed clinical support duties including obtaining vital signs,
   conducting urinalyses, rapid HIV tests, finger sticks,
   venipuncture, and administering injections
 * Prepared patients for exams and procedures, assisted clinicians
   during care, and provided education on pain management options
 * Delivered unbiased, factual patient education on pregnancy options,
   ...
   resources as needed
 * Dispensed medications and supplies under clinician direction, and
